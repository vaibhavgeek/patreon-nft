...
const connectZilpay = async () => {
  try {
    ...
    if (window.zilPay.wallet.isConnect) {
      ...
      localStorage.setItem("user_account" , JSON.stringify(window.zilPay.wallet.defaultAccount));
            ...
            <>
              ...
              >
                <div className="header-nav-inner">
                  {localStorage.getItem("zilpay_connect") ? (
                    <ul
                      className={classNames(
                        "list-reset text-xs",
